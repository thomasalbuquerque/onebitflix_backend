...
const WatchTime_1 = require("../models/WatchTime");
exports.episodeService = {
    ...
    getWatchTime: (userId, episodeId) => __awaiter(void 0, void 0, void 0, function* () {
        const watchTime = yield WatchTime_1.WatchTime.findOne({
            attributes: ['seconds'],
            where: {
                userId,
                episodeId
    ...
    setWatchTime: ({ userId, episodeId, seconds }) => __awaiter(void 0, void 0, void 0, function* () {
        const watchTimeAlreadyExists = yield WatchTime_1.WatchTime.findOne({
            where: {
                userId,
                episodeId
            }
        ...
        if (watchTimeAlreadyExists) {
            ...
            const watchTime = yield WatchTime_1.WatchTime.create({
                userId,
                episodeId,
                seconds
            });
