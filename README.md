Frontend code repository for OneBitFlix, an online course platform for programming courses. It is a result of an exercise from the course Full Stack Javascript from OneBitCode company.
